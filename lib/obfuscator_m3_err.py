...
def generate_table():
    ...
    TABLE['C'] = '[][' + generate_string('filter') + '][' + generate_string('constructor') + '](' + generate_string('return escape') + ')()(' + TABLE['1'] + '[' + generate_string("sub") + ']())[' + TABLE[
        2] + ']'
...
if __name__ == "__main__":
    # 代码实现有问题, 无法完善的运行,当jsfuck存在复杂语句时,无法运行
    js_code = "alert(1)"
    print(obfuscate(js_code))
